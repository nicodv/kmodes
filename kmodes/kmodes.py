...
def labels_cost(X, centroids, dissim, w1, w2, membship=None, sample_weight=None):
...
#                   sample_weight):
def _k_modes_iter(X, centroids, cl_attr_freq, membship, dissim, w1, w2, random_state,
                  sample_weight):
    """
        :param X: 数据集
        :param centroids: 簇心
